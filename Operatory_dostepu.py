print("_" * 65, "operatory arytmetyczne")
import math
...
print("_" * 65, "operatory porownania")
...
print("_" * 65, "Tupla")
# Tupla, krotka (ang. tuple) w nawiasach okrągłych
...
# operator dostepu
# print(a[1]) #wartość wpisana w nawiasie kwadratowym informuje do której wartości w tupli się odnosimy. Liczymu od 0
...
# a = (10, 20, 30)
# print(len(a))# poda ilośc wartości w tupli
# print(min(a)) # poda najmniejszą wartość w tupli
# print(max(a))  # poda największą wartość w tupli
# print(min(a))  # poda najmniejszą wartość w tupli
# print(sum(a)) # poda sumę wartość w tupli
...
# print(a[:])  # ('a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j') wszystko
# i = 1
# print(a[i])  # b
# print(a[-1])  # j
# print(a[-5:-2])  # ('f', 'g', 'h')
...
# print(a[-3:])  # ('h', 'i', 'j')
# print(a[::2])  # ('a', 'c', 'e', 'g', 'i')- pozwala na wyciągnięcie co którejś wartości.
# print(a[::-25])  # ('j',)
# print(a[::25])  # ('a',)
# print(a[::-2])  # ('j', 'h', 'f', 'd', 'b')
...
# lista_a.insert(3, 35) # wstawia element podany w drufiej wartości (35) na miejsce w liście podane w 1 argumencie (3)
# print(lista_a)
...
#     i += 1
# else:
#     # to co jest w tym else wykona sie tylko wtedy, kiedy nie przerwie petli za pomoca break
#     print('Else po while')
